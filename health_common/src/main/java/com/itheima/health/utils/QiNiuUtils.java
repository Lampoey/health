...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "WSfSrmd3tRXYJX8tgNIEtY61RTEdBYxKq_LzB8gX";
    private static final String SECRETKEY = "90AlDOjU_I0szbk_5samTAqIhkODNhh_4E7u7qku";
    private static final String BUCKET = "sz-health-01";
    public static final String DOMAIN= "http://qkateu0ro.hn-bkt.clouddn.com/";
